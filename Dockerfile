...
CMD LD_LIBRARY_PATH=/root/mjpg-streamer-master/mjpg-streamer-experimental /root/mjpg-streamer-master/mjpg-streamer-experimental/mjpg_streamer -i "input_raspi.so -o "output_http.so -w /root/mjpg-streamer-master/mjpg-streamer-experimental/www -p 8080" -x 1920 -y 1080 -fps 30
