...
CMD LD_LIBRARY_PATH=/root/mjpg-streamer/mjpg-streamer-experimental /root/mjpg-streamer/mjpg-streamer-experimental/mjpg_streamer -i "input_uvc.so -d /dev/video0" -o "output_http.so -w /root/mjpg-streamer-master/mjpg-streamer-experimental/www -p 8080" -r "1920x1080" -f "30"
